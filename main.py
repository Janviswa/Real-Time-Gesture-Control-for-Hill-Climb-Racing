...
import time
from directkeys import right_pressed, left_pressed, nitro_pressed
    ...
    while True:
        ...
        if len(lmList) != 0:
            ...
            if total == 0:
                ...
                cv2.putText(image, "NITRO", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                            2, (0, 0, 0), 5)
                PressKey(nitro_pressed)
                current_key_pressed.add(nitro_pressed)
                key_pressed = nitro_pressed
                keyPressed = True
                key_count += 1
        ...
        # Release previously pressed keys if gesture changes
